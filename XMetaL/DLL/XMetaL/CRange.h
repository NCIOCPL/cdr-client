...
public:
	...
	LPDISPATCH get_NodeItem(long index)
	{
		LPDISPATCH result;
		static BYTE parms[] = VTS_I4;
		InvokeHelper(0x208, DISPATCH_PROPERTYGET, VT_DISPATCH, (void*)&result, parms, index);
		return result;
	}
	LPDISPATCH get_RangeItem(long index)
	{
		LPDISPATCH result;
		static BYTE parms[] = VTS_I4;
		InvokeHelper(0x209, DISPATCH_PROPERTYGET, VT_DISPATCH, (void*)&result, parms, index);
		return result;
	}
	long get_count()
	{
	...
	void UnpinContainer()
	{
		InvokeHelper(0x212, DISPATCH_METHOD, VT_EMPTY, NULL, NULL);
	}
	void DOMMoveLeft(long MovementType)
	{
		static BYTE parms[] = VTS_I4;
		InvokeHelper(0x213, DISPATCH_METHOD, VT_EMPTY, NULL, parms, MovementType);
	}
	void DOMMoveRight(long MovementType)
	{
		static BYTE parms[] = VTS_I4;
		InvokeHelper(0x214, DISPATCH_METHOD, VT_EMPTY, NULL, parms, MovementType);
	}
